...
class Movie (@Id private val id: String, private val userId: Long, private val title: String,
    ...
    fun toJson(): MovieJ {
        return MovieJ(overview, languages, search_title, title, genres, poster_path, year, release_date, id, userId, director, cast, runtime, reviews, rating)
    }
